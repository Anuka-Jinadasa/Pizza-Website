...
tr:nth-child(odd){background-color:#f0f5f5}
	...
	<body>
			...
			<h1 class ="heading">Remove items</h1>
	...
	<td><?php echo number_format($row['r_price'],2);?></td>
	<td><?php echo number_format($row['l_price'],2);?></td>

	 <td><a href = "<?php echo $_SERVER['PHP_SELF'];?>?delete_Item=<?php echo $row['id'];?>">Remove</a></td>
		 </tr>
		<?php } } ?>	
</table>
